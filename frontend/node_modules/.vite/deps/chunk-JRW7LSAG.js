...
var _excluded4 = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"];
...
var _excluded5 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"];
...
var Popover = React6.forwardRef(function Popover2(inProps, ref) {
  ...
  const {
    ...
    disableScrollLock = false
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded6), other = _objectWithoutPropertiesLoose(props, _excluded22);
  const externalPaperSlotProps = (_slotProps$paper = slotProps == null ? void 0 : slotProps.paper) != null ? _slotProps$paper : PaperPropsProp;
  const paperRef = React6.useRef();
  ...
  const getAnchorOffset = React6.useCallback(() => {
  ...
  const getTransformOrigin = React6.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React6.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React6.useState(open);
  const setPositioningStyles = React6.useCallback(() => {
  ...
  React6.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
...
true ? Popover.propTypes = {
   ...
   */
  anchorEl: chainPropTypes(import_prop_types6.default.oneOfType([HTMLElementType, import_prop_types6.default.func]), (props) => {
  ...
  anchorOrigin: import_prop_types6.default.shape({
    horizontal: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["center", "left", "right"]), import_prop_types6.default.number]).isRequired,
    vertical: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["bottom", "center", "top"]), import_prop_types6.default.number]).isRequired
  }),
  /**
   * This is the position that may be used to set the position of the popover.
   * The coordinates are relative to the application's client area.
   */
  anchorPosition: import_prop_types6.default.shape({
   ...
   * @default 'anchorEl'
   */
  anchorReference: import_prop_types6.default.oneOf(["anchorEl", "anchorPosition", "none"]),
  /**
   * The content of the component.
   */
   ...
   * @default 16
   */
  marginThreshold: import_prop_types6.default.number,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   */
   ...
   * @default {}
   */
  PaperProps: import_prop_types6.default.shape({
   ...
   * }
   */
  transformOrigin: import_prop_types6.default.shape({
    horizontal: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["center", "left", "right"]), import_prop_types6.default.number]).isRequired,
    vertical: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["bottom", "center", "top"]), import_prop_types6.default.number]).isRequired
  }),
  /**
...
var Menu = React7.forwardRef(function Menu2(inProps, ref) {
...
true ? Menu.propTypes = {
   ...
   */
  anchorEl: import_prop_types7.default.oneOfType([HTMLElementType, import_prop_types7.default.func]),
  /**
   ...
   * @default false
   */
  disableAutoFocusItem: import_prop_types7.default.bool,
  /**
   * Props applied to the [`MenuList`](/material-ui/api/menu-list/) element.
   * @default {}
   */
  MenuListProps: import_prop_types7.default.object,
  /**
   * Callback fired when the component requests to be closed.
   *
   * @param {object} event The event source of the callback.
   ...
   */
  PopoverClasses: import_prop_types7.default.object,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   *
   ...
   * @default 'selectedMenu'
   */
  variant: import_prop_types7.default.oneOf(["menu", "selectedMenu"])
} : void 0;
...
var _excluded8 = ["className", "disabled", "error", "IconComponent", "inputRef", "variant"];
...
var NativeSelectInput = React8.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime11.jsxs)(React8.Fragment, {
    children: [(0, import_jsx_runtime10.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime10.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var _span;
var _excluded9 = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = React9.forwardRef(function SelectInput2(props, ref) {
  ...
  const displayRef = React9.useRef(null);
  const [displayNode, setDisplayNode] = React9.useState(null);
  const {
    current: isOpenControlled
  } = React9.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React9.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React9.useCallback((node) => {
  ...
  React9.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  return (0, import_jsx_runtime13.jsxs)(React9.Fragment, {
    children: [(0, import_jsx_runtime12.jsx)(SelectSelect, _extends({
    ...
    })), (0, import_jsx_runtime12.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime12.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime12.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
true ? SelectInput.propTypes = {
   ...
   * @ignore
   */
  type: import_prop_types9.default.any,
  /**
   * The input value.
   */
...
var _excluded10 = ["disableUnderline", "components", "componentsProps", "fullWidth", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
var _excluded11 = ["disableUnderline", "components", "componentsProps", "fullWidth", "hiddenLabel", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
var _span2;
var _excluded12 = ["children", "classes", "className", "label", "notched"];
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(NotchedOutlineRoot, _extends({
    "aria-hidden": true,
    className,
    ownerState
  }, other, {
    children: (0, import_jsx_runtime16.jsx)(NotchedOutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime16.jsx)("span", {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
...
var _excluded13 = ["components", "fullWidth", "inputComponent", "label", "multiline", "notched", "slots", "type"];
...
var OutlinedInput = React13.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(InputBase_default, _extends({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
    renderSuffix: (state) => (0, import_jsx_runtime18.jsx)(NotchedOutlineRoot2, {
      ownerState,
      className: classes.notchedOutline,
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime17.jsxs)(React13.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var _excluded14 = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"];
...
var Select = React14.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(React14.Fragment, {
...
//# sourceMappingURL=chunk-JRW7LSAG.js.map
